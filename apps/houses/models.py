...
class School(models.Model):
    ...
    advantage = models.CharField(max_length=80, verbose_name='学校的地理优势', default='')
    school_front_image = models.ImageField(upload_to='school', verbose_name='学校风采', null=True)
...
class Position(models.Model):
    ...
    def __str__(self):
        return '{!s}距{!s}{!s}米'.format(self.house, self.school, self.distance)
