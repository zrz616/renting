                ...
                <div class="ui vertical segment masterhead">
                    <div class="ui text menu in-masterhead">
                        ...
                        <div v-if='is_login' v-cloak class="ui right text menu in-menu-masterhead">
                            ...
                            <div v-on:click='logout' class="ui circular logout button in-menu-masterhead">
                                <span class="text-register in-menu-masterhead">注销</span>
                            </div>
                        </div>
                        <div v-else v-cloak class="ui right text menu in-menu-masterhead">
                            <!-- login -->
                            <router-link to="/login" class="text-login in-menu-masterhead">登录</router-link>
                            <!-- register button -->
                            <router-link to="/register" class="ui circular button in-menu-masterhead">
...
<style scoped>
    ...
    .ui.circular.logout.button.in-menu-masterhead {
        background-color: #fcc416;
        width: 112px;
        height: 33px;
        padding: 8px 0 0 0;
